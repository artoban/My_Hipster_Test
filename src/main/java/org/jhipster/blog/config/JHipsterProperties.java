...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "hipstagram@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "hipstagram API";

        private String description = "hipstagram API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "hipstagram";
